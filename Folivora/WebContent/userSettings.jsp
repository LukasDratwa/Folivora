    		...
    		<div class="col-md-9">
    			...
    			<form role="form"  method="post">
   					<div class="form-group">
						...
						<input class="form-control" value="<% out.write(usr.getName()); %>" disabled="disabled" />
					</div>
   					<div class="form-group">
						<label for="hometown">Geburtstag:</label>
						<input type="text" name="birthday" class="form-control" placeholder="Geburtstag eingeben" <% out.write(usr.getBirthday() == null ? "" : SimpleDateFormat.getDateInstance(SimpleDateFormat.SHORT).format(usr.getBirthday())); %> />
					</div>
   					<div class="form-group">
   						...
   						<div class="input-group">
							<div class="input-group-btn">
								<button type="button" class="btn btn-default btn-block dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<% out.write("" + usr.getGender()); %> <span class="caret"></span>
								</button>
   					...
   					<div class="form-group">
						...
						<input type="text" name="hometown" class="form-control" placeholder="Wohnort eingeben" value="<% out.write(usr.getHometown()); %>" />
					</div>
   					<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="input-group">
						<input type="text" class="form-control" value="<% out.write("" + usr.getCredit().getBalance()); %>" />
